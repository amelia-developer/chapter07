...
import { fetchSelectedBestMenuProductId, setProductCountMinus, setProductCountPlus, setOptionChoice } from '../../redux/action'
...
const Info = ({bestMenu, fetchSelectedBestMenuProductId, productDetailCount, setProductCountMinus, setProductCountPlus, optionChoice, setOptionChoice}) => {
    ...
    // 셀렉옵션에 옵션을 선택하면 해당옵션의 price가져오고 + 카운트갯수 x 금액을 더한값
    const productCalculate = ((parseInt(optionChoice) + selectedProduct.price) * productDetailCount).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ',')
            ...
            <div className="infoBox">
                ...
                <div className="itemInner">
                    ...
                    <div className="totalBox">
                        ...
                        <span className="price">{productCalculate}</span>
